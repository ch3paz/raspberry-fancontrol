...
sht_sensor_clock = int(ffpi_configparser.get('ffpi_sht75_settings', 'sensorclock'))
sht_sensor_1_data = int(ffpi_configparser.get('ffpi_sht75_settings', 'sensor1data'))
sht_sensor_2_data = int(ffpi_configparser.get('ffpi_sht75_settings', 'sensor2data'))
